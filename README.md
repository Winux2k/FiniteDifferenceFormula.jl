...
This Julia package, also ported to Python, https://github.com/fdformula/FiniteDifferenceFormula.py, provides a general tool kit for generating finite difference formulas, working with Taylor series expansions,
